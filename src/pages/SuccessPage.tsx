    ...
    <div className="success-page">
      <div className="success-card">
        ...
        <p className="success-body">
          Thank you for your purchase. Your download link is on its way to your inbox right now.
        ...
        <div className="success-note">
          The email includes your personal download link, valid for 48 hours and up to 5 downloads.
          Save the file once it is downloaded.
        </div>
